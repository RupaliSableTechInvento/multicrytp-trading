...
var mLayout = function() {
  ...
  var initHorMenu = function() {
    ...
    horMenuOffcanvas = $('#m_header_menu1').mOffcanvas({
      class: 'm-aside-header-menu-mobile',
      overlay: true,
      close: '#m_aside_header_menu_mobile_close_btn',
      toggle: {
    ...
    horMenu = $('#m_header_menu1').mMenu({
      ...
      resize: {
        desktop: function() {
          var headerNavWidth = $('#m_header_nav1').width();
          var headerMenuWidth = $('#m_header_menu_container1').width();
          var headerTopbarWidth = $('#m_header_topbar1').width();
          var spareWidth = 20;
