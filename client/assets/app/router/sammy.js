...
(function(g, i) {
  console.log("sammy.js");
  var n, f = "([^/]+)",
    j = /:([\w\d]+)/g,
    k = /\?([^#]*)$/,
    b = function(o) { return Array.prototype.slice.call(o) },
    ...
    e = function(o) { return o.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;") },
  ...
  n = function() {
    var p = b(arguments),
      q, o;
    n.apps = n.apps || {};
    if (p.length === 0 || p[0] && c(p[0])) { return n.apply(n, ["body"].concat(p)) } else {
  ...
  if (typeof i.console != "undefined") { if (c(console.log.apply)) { n.addLogger(function() { i.console.log.apply(console, arguments) }) } else { n.addLogger(function() { i.console.log(arguments) }) } } else { if (typeof console != "undefined") { n.addLogger(function() { console.log.apply(console, arguments) }) } }
  g.extend(n, { makeArray: b, isFunction: c, isArray: l });
  n.Object = function(o) { return g.extend(this, o || {}) };
  g.extend(n.Object.prototype, {
    escapeHTML: e,
    h: e,
    toHash: function() {
      var o = {};
    ...
    keys: function(o) { var p = []; for (var q in this) { if (!c(this[q]) || !o) { p.push(q) } } return p },
    has: function(o) { return this[o] && g.trim(this[o].toString()) != "" },
    join: function() { var p = b(arguments); var o = p.shift(); return p.join(o) },
  ...
  n.HashLocationProxy.prototype = {
    ...
    getLocation: function() { var o = i.location.toString().match(/^[^#]*(#.+)$/); return o ? o[1] : "" },
    ...
    _startPolling: function(q) {
      ...
      if (!n.HashLocationProxy._interval) {
        ...
        var o = function() {
          var r = p.getLocation();
          if (!n.HashLocationProxy._last_location || r != n.HashLocationProxy._last_location) { i.setTimeout(function() { g(i).trigger("hashchange", [true]) }, 13) }
  ...
  n.Application.prototype = g.extend({}, n.Object.prototype, {
    ...
    toString: function() { return "Sammy.Application:" + this.element_selector },
    ...
    use: function() {
      ...
      try {
        ...
        q.apply(this, o)
      } catch (r) { if (typeof q === "undefined") { this.error("Plugin Error: called use() but plugin (" + p.toString() + ") is not defined", r) } else { if (!c(q)) { this.error("Plugin Error: called use() but '" + p.toString() + "' is not a function", r) } else { this.error("Plugin Error", r) } } }
      return this
    },
    ...
    route: function(s, p, u) {
      ...
      if (s === "any") { g.each(this.ROUTE_VERBS, function(x, w) { o(w) }) } else { o(s) }
      return this
    },
    get: m("get"),
    post: m("post"),
    ...
    trigger: function(o, p) { this.$element().trigger([o, this.eventNamespace()].join("."), [p]); return this },
    refresh: function() {
    ...
    around: function(o) { this.arounds.push(o); return this },
    isRunning: function() { return this._running },
    helpers: function(o) { g.extend(this.context_prototype.prototype, o); return this },
    helper: function(o, p) { this.context_prototype.prototype[o] = p; return this },
    run: function(o) {
      ...
      this.bind("submit", function(r) { var q = p._checkFormSubmission(g(r.target).closest("form")); return (q === false) ? r.preventDefault() : false });
    ...
    lookupRoute: function(r, p) {
      ...
      if (typeof this.routes[r] != "undefined") { g.each(this.routes[r], function(t, s) { if (q.routablePath(p).match(s.path)) { o = s; return false } }) }
      return o
    },
    runRoute: function(q, D, s, v) {
      var r = this,
        B = this.lookupRoute(q, D),
        p, y, t, x, C, z, w, A, o;
      ...
      if (B) {
        ...
        if ((A = B.path.exec(this.routablePath(D))) !== null) {
          ...
          g.each(A, function(E, F) {
            if (B.param_names[E]) { s[B.param_names[E]] = h(F) } else {
              if (!s.splat) { s.splat = [] }
              s.splat.push(h(F))
            }
          })
        ...
        y = function() {
          var E;
          while (C.length > 0) { z = C.shift(); if (r.contextMatchesOptions(p, z[0])) { E = z[1].apply(p, [p]); if (E === false) { return false } } }
          r.last_route = B;
        ...
        try { o = y() } catch (u) { this.error(["500 Error", q, D].join(" "), u) }
        return o
    ...
    contextMatchesOptions: function(r, t, p) {
      ...
      if (q.only) { return this.contextMatchesOptions(r, q.only, true) } else { if (q.except) { return this.contextMatchesOptions(r, q.except, false) } }
      var o = true,
        s = true;
      if (q.path) { if (c(q.path.test)) { o = q.path.test(r.path) } else { o = (q.path.toString() === r.path) } }
    ...
    templateCache: function(o, p) { if (typeof p != "undefined") { return a[o] = p } else { return a[o] } },
    clearTemplateCache: function() { return a = {} },
    notFound: function(q, p) { var o = this.error(["404 Not Found", q, p].join(" ")); return (q === "get") ? o : true },
    error: function(p, o) {
      if (!o) { o = new Error() }
      o.message = [p, o.message].join(" ");
      this.trigger("error", { message: o.message, error: o });
      if (this.raise_errors) { throw (o) } else { this.log(o.message, o) }
    },
    ...
    _parseFormParams: function(o) {
      var r = {},
        q = o.serializeArray(),
        p;
      for (p = 0; p < q.length; p++) { r = this._parseParamPair(r, q[p].name, q[p].value) }
      return r
    },
    ...
    _parseParamPair: function(q, o, p) { if (q[o]) { if (l(q[o])) { q[o].push(p) } else { q[o] = [q[o], p] } } else { q[o] = p } return q },
  ...
  g.extend(n.RenderContext.prototype, {
    then: function(q) {
      if (!c(q)) {
      ...
      var o = this;
      if (this.waiting) { this.callbacks.push(q) } else {
        this.wait();
        i.setTimeout(function() { var r = q.apply(o, [o.content, o.previous_content]); if (r !== false) { o.next(r) } }, 13)
      }
      return this
    },
      ...
      return this.then(function() {
        ...
        if (typeof o === "string") {
          ...
          g.ajax(g.extend({
            url: o,
            data: {},
            dataType: v ? "json" : null,
            type: "get",
            success: function(w) {
              if (s) { q.event_context.app.templateCache(o, w) }
              q.next(w)
            }
          }, p));
          return false
        } else { if (o.nodeType) { return o.innerHTML } if (o.selector) { q.next_engine = o.attr("data-engine"); if (p.clone === false) { return o.remove()[0].innerHTML.toString() } else { return o[0].innerHTML.toString() } } }
      })
    },
    render: function(o, p, q) { if (c(o) && !p) { return this.then(o) } else { if (!p && this.content) { p = this.content } return this.load(o).interpolate(p, o).then(q) } },
    ...
    swap: function() { return this.then(function(o) { this.event_context.swap(o) }).trigger("changed", {}) },
    appendTo: function(o) { return this.then(function(p) { g(o).append(p) }).trigger("changed", {}) },
    prependTo: function(o) { return this.then(function(p) { g(o).prepend(p) }).trigger("changed", {}) },
    replace: function(o) { return this.then(function(p) { g(o).html(p) }).trigger("changed", {}) },
    trigger: function(o, p) {
      return this.then(function(q) {
        if (typeof p == "undefined") { p = { content: q } }
  ...
  n.EventContext.prototype = g.extend({}, n.Object.prototype, {
    ...
    send: function() { var o = new n.RenderContext(this); return o.send.apply(o, arguments) },
    redirect: function() {
      var q, p = b(arguments),
        o = this.app.getLocation();
      if (p.length > 1) {
        p.unshift("/");
    ...
    trigger: function(o, p) { if (typeof p == "undefined") { p = {} } if (!p.context) { p.context = this } return this.app.trigger(o, p) },
